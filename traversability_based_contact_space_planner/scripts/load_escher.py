...
def escher(env, active_dof_mode='whole_body', urdf_name=None):
    ...
    escher.robot_z = 0.9
    escher.top_z = 1.85
    escher.shoulder_z = 1.45
    escher.shoulder_w = 0.6
    ...
    escher.foot_transition_long_radius = 0.7
    escher.foot_transition_short_radius = 0.3
    escher.max_body_transition_dist = 0.4
    escher.max_hand_transition_dist = 0.6
    ...
    # Construct the StandingPostureDOFValues
