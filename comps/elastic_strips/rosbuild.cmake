...
if (DEFINED ENV{ROS_ROOT})
  ...
  rosbuild_add_library(elastic_strips ElasticStrips.cpp Balance.cpp)
  target_link_libraries(elastic_strips qhull newmat)
  ...
  add_library(elastic_strips SHARED ElasticStrips.cpp Balance.cpp)
  set_target_properties(elastic_strips PROPERTIES
                        LINK_FLAGS ${OPENRAVE_LINK_FLAGS}
                        COMPILE_FLAGS ${OPENRAVE_CXXFLAGS})
  include_directories(${OPENRAVE_INCLUDE_DIRS} ${THIRDPARTY_DIR}/inc/newmat)
  target_link_libraries(elastic_strips ${OPENRAVE_LIBRARY} qhull newmat)

  install(TARGETS elastic_strips DESTINATION ${PLUGIN_INSTALL_DIR} )
